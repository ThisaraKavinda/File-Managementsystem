...
export default function UserRegistration() {
    ...
    const onAddUser = () => {
        ...
        if (name == "" && email == "" && mobile == "" && password == "" && repeatPass == "") {
                ...
                <div class="col">
                    ...
                    <div class="row g-0 d-flex justify-content-center ">
                        ...
                        <img src="https://mdbcdn.b-cdn.net/img/Photos/new-templates/bootstrap-registration/img4.webp"
                            ...
                            style={{borderTopLeftRadius: ".25rem", borderBottomLeftRadius: ".25rem", height: "795px"}} />
                        </div>
                        <div class="col-xl-6">
                            <div class="card-body p-md-5 text-black">
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-4">
                                        <div class="form-outline">
                                            ...
                                            <label class="form-label" for="form3Example1m">Mobile Number</label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12 mb-4">
                                        <div class="form-outline">
                                            <input type="password" id="form3Example1m" class="form-control form-control-lg"
                                            onChange={(e) => setRepeatPass(e.target.value)} value={repeatPass} />
                                            <label class="form-label" for="form3Example1m">Repeat Password</label>
                                        </div>
                                    </div>
                                </div>                          

                                <div class="d-flex justify-content-end pt-3">
                                    <button type="button" class="btn btn-light btn-lg" onClick={onReset}>Reset all</button>
                                    <button type="button" class="btn btn-warning btn-lg ms-2" onClick={onAddUser}>Submit form</button>
                                </div>
